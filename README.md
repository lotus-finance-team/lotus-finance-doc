...
For Mainnet launch, the fee is set at 10% (both protocol performance fee and strategy fee included, \~50% discount) to encourage participation and gather feedback from the community. Early withdrawal fee is set at 0.5% for the first 24 hours after user's last deposit, and 0 after 24 hours.
